"""AI model picker paints under the wayland backend.
...
def test_ai_model_picker_paints_under_wayland(xwpe):
    ...
    assert changed_pixels(before, after) > 1500,         "the model picker did not paint under wayland (screen barely changed)"
